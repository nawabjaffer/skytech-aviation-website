...
const DistributorsEnhanced: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [distributorsData, testimonialsData] = await Promise.all([
          googleSheetsService.getExistingDistributors(),
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-[#0b6d94] via-[#0a5a7a] to-[#073d53] text-white py-32">          {/* Animated Background Shapes */}
          ...
          <div className="absolute bottom-0 left-0 right-0">
            <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-50 dark:text-gray-900">
